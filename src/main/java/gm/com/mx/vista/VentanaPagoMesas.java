...
import gm.com.mx.controlador.ControladorPagoMesa;
...
public final class VentanaPagoMesas extends JFrame {
    ...
    public VentanaPagoMesas(List<Ticket> listaMesas) {
        ...
        addWindowListener(new ControladorPagoMesa(this));
        pack();
    ...
    public void panelMesas(List<Ticket> listaMesas) {
        ...
        btnCancelar.addActionListener(new ControladorPagoMesa(this));
        ...
        for (int i = 0; i < listaMesas.size(); i++) {
            ...
            btnMesas[i].addActionListener(new ControladorPagoMesa(this));
